...
# cfg.img_model.attention_resolutions = "4,2,1"
...
cfg.img_cond_model.condition_dim = sum(cfg.param_model.n_params)
cfg.img_cond_model.condition_proj_dim = 512
...
# cfg.img_cond_model.attention_resolutions = "4,2,1"
