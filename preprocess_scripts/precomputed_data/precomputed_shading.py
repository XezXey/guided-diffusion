...
parser.add_argument('--data_dir', type=str, default='/data/mint/DPM_Dataset/ffhq_256_with_anno/rendered_images/deca_masked_face_woclip/')
...
if __name__ == '__main__':
    ...
    def proc_i(i):
        ...
        img = cv2.resize(img, (args.resolution, args.resolution), interpolation=cv2.INTER_AREA)
