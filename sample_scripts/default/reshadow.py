...
def make_condition(cond, src_idx, dst_idx, n_step=2, itp_func=None):
    ...
    interp_cond = mani_utils.iter_interp_cond(
        # Relugar relighting
        cond, 
        ...
        interp_fn=itp_func, 
        # Shadows args
        add_remove_shadow=args.add_remove_shadow,
        add_shadow_to=args.add_shadow_to, 
        remove_shadow_to=args.remove_shadow_to,
        vary_shadow=args.vary_shadow, 
        vary_shadow_range=args.vary_shadow_range)
...
if __name__ == '__main__':
    ...
    elif args.dataset in ['mp_valid', 'mp_test', 'mp_test2', 'mp_valid2']:
