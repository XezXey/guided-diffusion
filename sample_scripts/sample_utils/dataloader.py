    ...
    *,
    ...
    for in_image_type in cfg.img_cond_model.in_image:
        if 'deca' in in_image_type:
            in_image[in_image_type] = _list_image_files_recursively(f"/data/mint/ffhq_256_with_anno/shading_images/{set_}/anno/")
        elif 'faceseg' in in_image_type:
            in_image[in_image_type] = _list_image_files_recursively(f"/data/mint/ffhq_256_with_anno/face_segment/{set_}/anno/")
