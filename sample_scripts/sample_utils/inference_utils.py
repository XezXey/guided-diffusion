...
def prepare_cond_sampling(cond, cfg, use_render_itp=False, device='cuda'):
    ...
    if cfg.img_cond_model.apply or (cfg.img_model.arch in ['ControlledUnetModel', 'ControlledUnetModel_no_xt', 'ControlledUnetModel_no_xt_no_nonspa', 'ControlledUnetModel_no_nonspa', 'ControlledUnetModel_DPPNonSpa', 'DPP_Spatial_with_CA']):
        cond_img = []
