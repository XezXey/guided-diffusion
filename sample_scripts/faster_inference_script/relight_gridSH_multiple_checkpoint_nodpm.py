...
python relight_paired_gridSH_nodpm.py --ckpt_selector model --dataset ffhq --set valid --step 020000 --out_dir /data/mint/sampling/paired_training_gridSH 
...
for ckpt in args.ckpt_step:
    ...
    cmd = (
        f"""
        python relight_paired_gridSH_nodpm.py --ckpt_selector {args.ckpt_type} --dataset ffhq --set valid --step {ckpt} --out_dir {args.out_dir} \
