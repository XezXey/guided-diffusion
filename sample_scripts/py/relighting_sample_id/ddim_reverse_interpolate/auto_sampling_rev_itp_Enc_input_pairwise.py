...
def without_classifier(itp_func, b_idx, src_idx, dst_idx, b_id, src_id, dst_id):
...
if __name__ == '__main__':
    ...
    for sj_src in sj_src_list:
        for sj_dst in sj_dst_list:
            ...
            print(f"[#] Set = {args.set}, Pair of {src_id} <===> {dst_id}")
            ...
            if args.slerp:
                ...
                without_classifier(itp_func=mani_utils.slerp, 
                                b_idx = 0, src_idx = 0, dst_idx = 1, 
                                b_id = img_name[0], src_id = img_name[0], dst_id = img_name[1],
                                )
                
                # 1 ---> 0
                without_classifier(itp_func=mani_utils.slerp, 
                                b_idx = 1, src_idx = 1, dst_idx = 0, 
                                b_id = img_name[1], src_id = img_name[1], dst_id = img_name[0],
                                )
