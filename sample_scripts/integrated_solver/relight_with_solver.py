...
if __name__ == '__main__':
    ...
    for i in range(start, end):
        ...
        #NOTE: Save result
        out_dir_relit = f"{args.out_dir}/log={args.log_dir}_cfg={args.cfg_name}{args.postfix}/{args.ckpt_selector}_{args.step}/{args.dataset}/{args.set}/{itp_str}/reverse_sampling/"
