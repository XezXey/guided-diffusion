...
do
    ...
    python ./relight_paired_nodpm_teaser.py \
        --ckpt_selector ema \
        --dataset ffhq_png \
        --set valid \
        --step 300000 \
        --out_dir /data/mint/sampling/TPAMI/main_result/ffhq/Website/fancy_rotate_spiral/ \
        --cfg_name paired+difareli+cs+nodpm+trainset_256.yaml \
        --log_dir backup_paired+difareli+cs+nodpm+trainset_256 \
        --seed 47 \
        --sample_pair_json /home/mint/Dev/DiFaReli/difareli-faster/visualize_scripts/TPAMI/main_results/FFHQ_CastShadows/For_Sel/aj_ake_samples.json \
        ...
        --postfix maxC \
        --spiral_sh \
        --light_traj_path /home/mint/Dev/DiFaReli/difareli-faster/experiment_scripts/TPAMI/Teaser/light_traj_n400_spiral_4_0.83_0.3_stf128-300.npy \
