...
class ControlledUnetModel_no_xt_no_hint_block(UNetModel):
...
class ControlNet_no_xt_no_hint_block(nn.Module):
    def __init__(
            self,
            image_size,
            in_channels,
...
class ControlNetWrapper_no_xt_no_hint_block(nn.Module):
    def __init__(self, controlnet: ControlNet_no_xt_no_hint_block, unet: ControlledUnetModel_no_xt_no_hint_block, control_mode='add'):
        super().__init__()
