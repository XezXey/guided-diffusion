...
class ResBlockConditionNoTime(TimestepBlockCond):
    """
    A residual block that can optionally change the number of channels.
...
class UNetModel_SpatialCondition_Hadamart_No_DPM_NoTime(nn.Module):
    """
    ...
    def __init__(
        ...
        resblock_module = ResBlock if not self.conditioning else ResBlockConditionNoTime
