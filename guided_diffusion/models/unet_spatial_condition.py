...
class UNetModel_SpatialCondition(nn.Module):
    """
                ...
                self.input_blocks.append(
                    time_embed_seq_module(
                        ...
                        if resblock_updown
                            ...
                            # int(ch//2), conv_resample, dims=dims, out_channels=int(out_ch//2)
                            ch, conv_resample, dims=dims, out_channels=int(out_ch//2)
                        )
                    )
                )
                ch = out_ch
