...
class ControlledUnetModel_no_xt_no_nonspa(UNetModel):
...
class ControlNet_no_xt_no_nonspa(nn.Module):
    def __init__(
            self,
            image_size,
            in_channels,
...
class ControlNetWrapper_no_xt_no_nonspa(nn.Module):
    def __init__(self, controlnet: ControlNet_no_xt_no_nonspa, unet: ControlledUnetModel_no_xt_no_nonspa):
        super().__init__()
