...
class ControlledUnetModel_no_decoder(UNetModel):
...
class ControlNet_no_decoder(nn.Module):
    def __init__(
            self,
            image_size,
            in_channels,
...
class ControlNetWrapper_no_decoder(nn.Module):
    def __init__(self, controlnet: ControlNet_no_decoder, unet: ControlledUnetModel_no_decoder):
        super().__init__()
